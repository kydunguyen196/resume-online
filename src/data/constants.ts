...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Jan 2023",
    endDate: "Jan 2025",
    title: "Fullstack Developer / Member",
    company: "Smart Lab - FPT University",
    description: [
      "Built and maintained frontend modules with ReactJS, JavaScript, TypeScript, HTML, and CSS in real-world university projects.",
      "Designed and integrated backend services through REST APIs to deliver end-to-end product features.",
  ...
  },
  {
    ...
    startDate: "Jan 2023",
    endDate: "Jun 2023",
    title: "Software Engineer Intern (Fullstack + API Integration)",
    company: "FPT Software",
    description: [
      "Integrated frontend interfaces with backend RESTful APIs to streamline client-server data flow.",
      "Developed web modules using JavaScript and Java while balancing backend reliability with frontend user experience.",
