...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.CSHARP]: {
    ...
    name: "csharp",
    label: "C#",
    shortDescription: "Backend language used for .NET application services.",
    color: "#239120",
    icon: "https://cdn.simpleicons.org/csharp/239120",
  },
  [SkillNames.DOTNET]: {
    id: 19,
    name: "dotnet",
    label: ".NET Framework",
    shortDescription: "Building structured backend APIs and business logic.",
    color: "#512bd4",
  ...
  [SkillNames.ENTITY_FRAMEWORK]: {
    ...
    shortDescription: "ORM-based data access for .NET backend applications.",
    color: "#512bd4",
    icon: "https://cdn.simpleicons.org/dotnet/512BD4",
  },
  ...
  [SkillNames.SQL_SERVER]: {
    ...
    name: "sql-server",
    label: "SQL Server",
    shortDescription: "Relational database management for .NET applications.",
    color: "#cc2927",
    icon: "https://cdn.simpleicons.org/microsoftsqlserver/CC2927",
  },
  [SkillNames.MYSQL]: {
    id: 25,
    name: "mysql",
  ...
  [SkillNames.SWAGGER]: {
    ...
    name: "swagger",
    label: "Swagger",
    shortDescription: "Documenting and validating backend API contracts.",
    color: "#85ea2d",
  ...
  [SkillNames.JWT]: {
    ...
    name: "jwt",
    label: "JWT",
    shortDescription: "Token-based authentication for protected API flows.",
    color: "#111827",
    icon: "https://cdn.simpleicons.org/jsonwebtokens/111827",
  },
  [SkillNames.AGILE]: {
    id: 29,
    name: "agile",
