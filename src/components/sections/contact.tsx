  ...
  return (
    <SectionWrapper id="contact" className="min-h-screen max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 z-[9999] mx-4">
        <Card className="w-full bg-white/80 dark:bg-black/70 backdrop-blur-sm rounded-xl mt-10 md:mt-20">
          <CardHeader>
            ...
            <CardDescription>
              ...
              <a
                ...
                className="text-primary underline underline-offset-4 cursor-can-hover rounded-lg"
              >
